...
def extract_plot_apartment_table(driver, xid):
    output_file = "haryana/haryana_plot_apartmentdetails2.csv"
            ...
            if any("Plot/ apartment type" in text for text in first_row_text):
                ...
                if not os.path.exists(output_file) or os.path.getsize(output_file) == 0:
                    with open(output_file, "w", newline="", encoding="utf-8") as f:
                        ...
                        writer.writerow(["RERA no."] + headers)
...
try:
    ...
    with open("haryana/focus2.csv", "r") as csvfile:
