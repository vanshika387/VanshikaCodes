...
# Load Excel file
file_path = r"inputDataForUrl2.xlsx"
...
for index, row in df.iterrows():
    ...
    query = f"{proj_name} {City} housing.com"
    ...
    with open(output_file, "a", newline="", encoding="utf-8") as f:
        ...
        if f.tell() == 0:  # Check if file is empty to write header
            writer.writerow(["XID", "Project Name", "City", "Housiing.com Link"])
